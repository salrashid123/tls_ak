...
const (
	...
	Verifier_GetTLSKey_FullMethodName = "/verifier.Verifier/GetTLSKey"
)
...
type VerifierClient interface {
	...
	GetTLSKey(ctx context.Context, in *GetAttestedKeyRequest, opts ...grpc.CallOption) (*GetAttestedKeyResponse, error)
}
...
func (c *verifierClient) GetTLSKey(ctx context.Context, in *GetAttestedKeyRequest, opts ...grpc.CallOption) (*GetAttestedKeyResponse, error) {
	out := new(GetAttestedKeyResponse)
	err := c.cc.Invoke(ctx, Verifier_GetTLSKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VerifierServer interface {
	...
	GetTLSKey(context.Context, *GetAttestedKeyRequest) (*GetAttestedKeyResponse, error)
}
...
func (UnimplementedVerifierServer) GetTLSKey(context.Context, *GetAttestedKeyRequest) (*GetAttestedKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTLSKey not implemented")
}
...
func _Verifier_GetTLSKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAttestedKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VerifierServer).GetTLSKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Verifier_GetTLSKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VerifierServer).GetTLSKey(ctx, req.(*GetAttestedKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Verifier_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTLSKey",
			Handler:    _Verifier_GetTLSKey_Handler,
		},
	},
